...
#define NGX_CACHE_IN_TIME_LEVEL 60
...
void ngx_rtmp_free_session(ngx_rtmp_session_t *s);

ngx_int_t ngx_rtmp_cmd_disconnect_init(ngx_rtmp_session_t *s, ngx_rtmp_header_t *h, ngx_chain_t *in);
